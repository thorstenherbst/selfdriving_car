      ...
      <div class="container">
        ...
        <div id="welcome">
          <h1>
            ...
            In this component everything which is needed in the whole app should be included.
            e.g (Sidebar Navigation or Header Navigation, Notifications, Modal Handling and more)
        </div>
        <!--  HERO  -->
